...
function hideEverything() {
 ...
 proceedButton.style.display = 'none'; // Hide the proceed button initially
}
...
x = setInterval(function () {
  ...
  if (distance > 0) {
    ...
    function openBox() {
      console.log('Current step:', step); // Add this line to check the value of step
      if (step === 1) {
      ...
      if (step === 4) {
        console.log('Calling showProceedButton'); // Add this line to check if the condition is met
        console.log(proceedButton);
        showProceedButton(); // Call the showProceedButton function when reaching step 4
        return;
      }
    ...
    function showProceedButton() {
      console.log('in showProceedButton');
      proceedButton.style.display = 'block'; // Display the proceed button
    }
  
    // Set a timeout to show the proceed button after 10 seconds
    setTimeout(showProceedButton, 10000);
  
    // Add an event listener to the proceed button to redirect to a new page
    proceedButton.addEventListener('click', function () {
      window.location.href = 'slide.html'; // Replace with your actual URL
    });
